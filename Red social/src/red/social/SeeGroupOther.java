 ...
 * @author Krle__000
 */
public class SeeGroupOther extends javax.swing.JFrame {

    /** Creates new form SeeGroupOther */
    public SeeGroupOther() {
        initComponents();
   ...
   private void initComponents()
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeeGroupOther.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeeGroupOther().setVisible(true);
            }
        });
    }
