...
public class Register extends javax.swing.JFrame
{
   ...
   public Register()
   {
    ...
    public Register(boolean AdminIsAddingUsers) {
        initComponents();
        InvisibleComponents();
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
   ...
   private void initComponents()
   {
      ...
      jLabel11.setForeground(new java.awt.Color(55, 160, 166));
      jLabel11.setText("¡Bienvenido a Lynx!");

      txt_User.setFont(new java.awt.Font("Century Gothic", 0, 11)); // NOI18N
      ...
      txt_LastName.setFont(new java.awt.Font("Century Gothic", 0, 11)); // NOI18N
      ...
      txt_CheckPassword.setFont(new java.awt.Font("Century Gothic", 0, 11)); // NOI18N
      ...
      txt_Mail.setFont(new java.awt.Font("Century Gothic", 0, 11)); // NOI18N
      ...
      txt_PhoneNumber.setFont(new java.awt.Font("Century Gothic", 0, 11)); // NOI18N
      ...
      Dp_Birthday.setFont(new java.awt.Font("Century Gothic", 0, 11)); // NOI18N
      Dp_Birthday.addMouseListener(new java.awt.event.MouseAdapter()
      {
         public void mouseClicked(java.awt.event.MouseEvent evt)
         {
            Dp_BirthdayMouseClicked(evt);
         }
      });
      ...
      lbl_LastNameError.setFont(new java.awt.Font("Century Gothic", 1, 11)); // NOI18N
      lbl_LastNameError.setForeground(new java.awt.Color(204, 0, 0));
      lbl_LastNameError.setText("Es necesario un apellido");

      jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/red/social/Icons/Blue.png"))); // NOI18N

      lbl_NameError.setFont(new java.awt.Font("Century Gothic", 1, 11)); // NOI18N
      ...
      jLabel3.setForeground(new java.awt.Color(71, 79, 89));
      ...
      jLabel7.setForeground(new java.awt.Color(71, 79, 89));
      ...
      jLabel9.setForeground(new java.awt.Color(71, 79, 89));
      jLabel9.setText("Fecha de nacimiento");

      jLabel10.setFont(new java.awt.Font("Century Gothic", 1, 11)); // NOI18N
      jLabel10.setForeground(new java.awt.Color(71, 79, 89));
      jLabel10.setText("Descripción");

      txt_Description.setColumns(20);
      txt_Description.setFont(new java.awt.Font("Century Gothic", 0, 11)); // NOI18N
      ...
      jLabel8.setForeground(new java.awt.Color(71, 79, 89));
      ...
      btn_Register.setBackground(new java.awt.Color(234, 104, 0));
      btn_Register.setFont(new java.awt.Font("Century Gothic", 1, 11)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               ...
               .addGroup(jPanel1Layout.createSequentialGroup()
                  ...
                  .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                     .addComponent(Dp_Birthday, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                  ...
                  .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                     ...
                     .addComponent(lbl_Level, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)
                     .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                           .addComponent(lbl_UserError)
                           .addComponent(lbl_NameError)
                           .addComponent(lbl_LastNameError, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(18, 18, 18)
   ...
   {//GEN-HEADEREND:event_txt_LastNameKeyTyped
      // TODO add your handling code here:
   ...
   {//GEN-HEADEREND:event_txt_NameKeyTyped
      // TODO add your handling code here:
   ...
   {//GEN-HEADEREND:event_btn_RegisterActionPerformed
      // TODO add your handling code here:
       InvisibleComponents();
       if(IsDataValid()){ 
            LogFrame.dispose();
   ...
   private void Dp_BirthdayMouseClicked(java.awt.event.MouseEvent evt)//GEN-FIRST:event_Dp_BirthdayMouseClicked
   {//GEN-HEADEREND:event_Dp_BirthdayMouseClicked
      // TODO add your handling code here:
      try{
         if(Dp_Birthday.getDate().compareTo(new SimpleDateFormat("dd/MM/yyyy").parse("31/12/2008"))==1){
            Dp_Birthday.setDate(new SimpleDateFormat("dd/MM/yyyy").parse("31/12/2008"));
         }
      }catch(Exception e){
         
      }
   }//GEN-LAST:event_Dp_BirthdayMouseClicked
   ...
   private void CleanTxt()
    ...
    private String CreateUser(){
       try{
        return (txt_User.getText()+SEPARADOR+ txt_Name.getText()+SEPARADOR+ txt_LastName.getText()+SEPARADOR+ RedSocial.MD5(txt_Password.getText())+SEPARADOR+ IsManager()+SEPARADOR+Birthday()+SEPARADOR+ txt_Mail.getText()+SEPARADOR+ txt_PhoneNumber.getText()+SEPARADOR+ PicturePath+SEPARADOR+ txt_Description.getText() +SEPARADOR +"1");   
       }catch(Exception e){
          return "";
       }
      }
    private String Birthday(){
       return (new SimpleDateFormat("dd/MM/yyyy").format(Dp_Birthday.getDate()));
    }
